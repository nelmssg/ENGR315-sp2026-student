...
midNum2_index = len(even_list) //2
midNum1_index = midNum2_index - 1
midNum2 = even_list[midNum1_index]
midNum1 = even_list[midNum2_index]

# this is the final result. Modify this line, and the empty lines above, to solve the assignment
middle_average = (midNum1 + midNum2) / 2
